...
Use the rules and tables in [`README-calculus.md`](README-calculus.md) as your formula sheet. **Display** math below is pre-rendered to PNG in [`README-derivatives-practice.md`](README-derivatives-practice.md) (do not edit that file by hand).
