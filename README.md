...
| [`Day02/`](Day02/)–[`Day08/`](Day08/) | One guide per day: textbook sections for orthonormal bases & matrix decompositions (Day 2), vector calculus (Day 3), probability (Day 4), optimization (Day 5), models & regression (Day 6), PCA & GMM (Day 7), SVM (Day 8). Day 4 practice: [`README-practice.md`](Day04/README-practice.md). Day 5 terms & formulas: [`README.md`](Day05/README.md); numerical practice: [`README-practice.md`](Day05/README-practice.md). Day 6 beginner guide (Ch. 8–9): [`README.md`](Day06/README.md). Day 7 simple guide (PCA & GMM): [`README.md`](Day07/README.md). |
