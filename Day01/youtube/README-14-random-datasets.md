# YouTube README — Topic 14: Generating random datasets

**MML reference:** Chapter 6 (random variables, sampling), Chapters 8–9 (synthetic regression) — *Mathematics for Machine Learning*
...
2. **[The Normal Distribution, Clearly Explained!!!](https://www.youtube.com/watch?v=rzFX5NWojp0)** — StatQuest with Josh Starmer  
    **Maps to Ch. 6 / Ch. 9:** Gaussian noise and common **Gaussian** models for noise ε in regression.
...
To simulate data (for example *y* = **w**ᵀ**x** + ε with Gaussian ε), you need **random variables** (1), **distributions** (2), and **sampling** (3). Align notation with *Mathematics for Machine Learning* Chapter 6.
