# YouTube README — Topic 10: Inner products

**MML reference:** Chapter 3, §3.2 *Inner Products*
...
2. **[Cross products | Chapter 10, Essence of linear algebra](https://www.youtube.com/watch?v=eu6i7WJeinw)** — 3Blue1Brown  
    **Maps to §3.2 (optional):** Another product on vectors in ℝ³ (contrast with inner product).

---

## How to use

Video (1) is the main match for §3.2 (standard inner product on ℝⁿ). Video (2) is optional geometric contrast.
